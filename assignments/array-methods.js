...
let fullName = [];
let tempNames = runners.forEach(function(i) {
...
let largeShirts = runners.filter((shirts) => {
    return shirts.size === 'L';
});
console.log(largeShirts);

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into a ticketPriceTotal array and log the result
let ticketPriceTotal = runners.reduce((donationTotal, amountTotal) => {
    return donation.Total + donationAmount.donation;
}, 0);
